...
public class VNFgraph {
	...
	public VNFgraph(int vnfs, int lowcap, int maxcap, int lowband, int maxband, int branchnum){
		gengraph(vnfs, lowcap, maxcap, lowband, maxband, branchnum);
	}
	
	public VNFgraph(int[] graph, int[] nodew, int[] edgew, int[] spatial, 
	 ...
	 * determines the preferred domain for hosting the VNF */
	...
	/** set partitioning array, used when this VNFgraph object represents a partition of a larger VNF-graph
	 * the partitioning array maps the VNFs of this graph as nodes of the larger graph */
	...
	/** when this VNFgraph object represents a partition of a larger VNF-graph
	 * get the partitioning array that maps the VNFs of this graph as nodes of the larger graph */
