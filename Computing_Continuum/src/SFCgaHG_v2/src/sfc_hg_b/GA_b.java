...
public class GA_b {
	...
	public sfc_hg_c.GA_c ga_c;
	
	/** initialize GA with running parameters and network objects */
	public GA_b(int chroms, int gnrs, int sgnrs, String params[], String command[],
			...
			services.VNFgraph cnet, network.Hypergraph pnet){
	...
	public void genchromefit(Chromosome_b h) {
		...
		ga_c=new sfc_hg_c.GA_c(c[0], c[1], c[2], c[3], c[4],cnet, pnet);
		ga_c.init();
